            ...
            <div class="row">
                <div class="col-md-10 offset-md-1 col-lg-9 offset-lg-0">
                    <article class="single-post">
                        ...
                        <img src="../../../assets/images/blog/post-4.jpg" alt="article-01">
                        ...
                        <div class="widget related-store">
                            ...
                            <ul class="store-list md list-inline">
                                <li class="list-inline-item">
                                    <a href=""><img src="../../../assets/images/popular-offer/populer-offer-02.png" alt="store-image"></a>
                                </li>
                                <li class="list-inline-item">
                                    <a href=""><img src="../../../assets/images/popular-offer/populer-offer-03.png" alt="store-image"></a>
                                </li>
                                <li class="list-inline-item">
                                    <a href=""><img src="../../../assets/images/popular-offer/populer-offer-04.png" alt="store-image"></a>
                                </li>
                                <li class="list-inline-item">
                                    <a href=""><img src="../../../assets/images/popular-offer/populer-offer-05.png" alt="store-image"></a>
                                </li>
                                <li class="list-inline-item">
                                    <a href=""><img src="../../../assets/images/popular-offer/populer-offer-06.png" alt="store-image"></a>
                                </li>
                                <li class="list-inline-item">
                                    <a href=""><img src="../../../assets/images/popular-offer/populer-offer-07.png" alt="store-image"></a>
                                </li>
                            </ul>
                        </div>
                        <!-- Archive Widget -->
